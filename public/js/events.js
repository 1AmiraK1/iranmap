...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (searchForm) {
        searchForm.addEventListener("submit", function (e) {
            ...
            const province =
                searchForm.elements["province-search"]?.value?.trim() || "";
            const county =
                searchForm.elements["county-search"]?.value?.trim() || "";
            const title =
                searchForm.elements["title-search"]?.value?.trim() || "";
            const type =
                searchForm.elements["type-search"]?.value?.trim() || "";
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    provinceSearch.addEventListener("change", function (e) {
        ...
        fetch(`/get-counties?province=${encodeURIComponent(provinceId)}`)
            .then((response) => {
                if (!response.ok) {
            ...
            .then((data) => {
                ...
                countySelect.innerHTML = '<option value="">همه</option>';
